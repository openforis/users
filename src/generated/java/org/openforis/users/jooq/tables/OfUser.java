...
public class OfUser extends TableImpl<OfUserRecord> {
    ...
    private static final long serialVersionUID = -1895447381;
     ...
     */
    public final TableField<OfUserRecord, Long> ID = createField("ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("(NEXT VALUE FOR OF_USERS.SYSTEM_SEQUENCE_8A29C84B_9BFE_4DA2_83D3_79C4499BCC20)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

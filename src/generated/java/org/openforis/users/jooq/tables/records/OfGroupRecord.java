...
public class OfGroupRecord extends UpdatableRecordImpl<OfGroupRecord> implements Record10<Long, String, String, String, Boolean, Boolean, String, byte[], String, Timestamp> {

    private static final long serialVersionUID = -246078165;
     ...
     */
    @Override
    public Row10<Long, String, String, String, Boolean, Boolean, String, byte[], String, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row10<Long, String, String, String, Boolean, Boolean, String, byte[], String, Timestamp> valuesRow() {
     ...
     */
    @Override
    public OfGroupRecord values(Long value1, String value2, String value3, String value4, Boolean value5, Boolean value6, String value7, byte[] value8, String value9, Timestamp value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OfGroupRecord(Long id, String name, String label, String description, Boolean enabled, Boolean systemDefined, String visibilityCode, byte[] logo, String url, Timestamp creationDate) {
        super(OfGroup.OF_GROUP);
